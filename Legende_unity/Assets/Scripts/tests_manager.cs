...
public class tests_manager : MonoBehaviour
{
    ...
    public string[] base_objects_to_equip;
    ...
    void Start(){
        ...
        Invoke("addArmureObjectToPlayer",0.5f);
    }

    void addArmureObjectToPlayer(){
        foreach (string o in base_objects_to_equip)
        {
            GameObject objToAdd = GameObject.Find(o);
            if(objToAdd != null){
                objToAdd.GetComponent<inventory_object>().addObject();
            }
    ...
    void Update(){
        ...
        if(Input.GetKeyDown(KeyCode.KeypadMinus)){
            player_life.instance.change_player_life(-1);
        }
        ...
        if(!Player.activeSelf){
            ...
            if(Input.GetKey("up")){
                ...
                GamePad_manager.instance._game_pad_attribution = enum_manager.game_pad_attribution.nothing;
            }
